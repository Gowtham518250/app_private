          ...
          if (success) {
            ...
            if (action == 'save_sale' || action == 'sync_sale') {
              ...
              if (saleId.isNotEmpty) {
                // Persist the local acknowledgement before removing the outbox
                // item. The helper is intentionally awaited without assigning its
                // result so this remains compatible with older generated builds
                // where the method was declared Future<void>.
